            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        <label for="menu">Tên phương pháp</label>
                        <input type="text" class="form-control" name="name" value="{{ old('name') ?? $solution->name }}"
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="target"
                            value="{{ old('target') ?? $solution->target }}" placeholder="Nhập đối tượng">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="" cols="30" rows="5">{{ $solution->description }}</textarea>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="">
                            <img id="image_show" style="width: 100px;height:100px" src="{{ $solution->image }}"
                                alt="image" />
                            <input type="file" id="upload" accept=".png,.jpeg"/>
                        </div>
                        <input type="hidden" name="image" id="image" value="{{ old('image') ?? $solution->image }}">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="form-group">
