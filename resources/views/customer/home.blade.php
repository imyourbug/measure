    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            dataTableBranch = $("#tableBranch").DataTable({
                ajax: {
                    url: `/api/branches/getAll?customer_id=${$('#customer_id').val()}`,
                    dataSrc: "branches",
                },
                columns: [
                    // {
            ...
            dataTableTaskDetail = $("#tableTaskDetail").DataTable({
                ajax: {
                    url: `/api/taskdetails?customer_id=${$('#customer_id').val()}`,
                    dataSrc: "taskDetails",
                },
                columns: [{
                        data: "task.type.name"
                    ...
                    {
                        data: function(d) {
                            return `<a class="btn btn-primary btn-sm btn-edit" href="/customers/taskdetails/update/${d.id}">
                                        <i class="fas fa-edit"></i>
                                    </a>`;
                        },
                    },
        ...
        $(document).on("change", "#select-month-taskdetail", function() {
            let requestUrl = `/api/taskdetails?customer_id=${$('#customer_id').val()}&month=${$(this).val()}`;
